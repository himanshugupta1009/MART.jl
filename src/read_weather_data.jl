...
folder = "/media/storage/himanshu_storage/MART/WRF_Ensemble_Adam/ENS_MEM_"*model_num_string
...
function generate_relevant_dataset_wrf_nc(;
    ...
    filename = destination_folder * "/model_prediction_$model_num.nc"
...
generate_relevant_dataset_wrf_nc(model_num = model_num, 
                            source_folder = source_folder,
